...
public class LoginClient implements Runnable {
	...
	static final Logger logger = Logger.getLogger(LoginClient.class);
	...
	String initMsg = "[<MSGSIZE>( 116)][<Command>(LOGINUSER)][<Userid>(_mmcx_)][<Passwd>(_mmcx_)][<Ip>(10.10.105.127)][<Hostname>(harksoo-pc)][<Mac>(NONE)]";
	//String initMsg = "[<MSGSIZE>( 184)][<Command>(LOGINUSER)][<Userid>(superusr)][<Passwd>(1234)][<Ip>(10.10.105.127)][<Hostname>(harksoo-pc)][<Mac>(00:30:67:DD:D5:E1)][<ClientDate>(15073115)][<LoginType>(GUI)][<PID>(2340)]";
	...
	public LoginClient(OccmRecvQueue queue){
		client = this;
		this.queue = queue;
	}
			...
			b.group(group).channel(NioSocketChannel.class).option(ChannelOption.TCP_NODELAY, true)
					.handler(new ChannelInitializer<SocketChannel>() {
						...
						public void initChannel(SocketChannel ch) throws Exception {
							...
							p.addLast(new OccmDecoder(), new LoginClientHandler(initMsg, client));
						}
					});
	...
	public synchronized void LoginReturn(){
		this.notify();
	}
