angular.module("alarm.services").service("AlarmService", function($q, $timeout) {
	...
	service.CHANGE_SYSTEM_MONI = "/topic/smRealtimeAlarm";
...
}).service("AlarmServiceTwo", function($q, $timeout) {
...
}).service("AlarmChartService", function($q, $timeout) {
...
//		}
	...
	initialize();
	return service;
}).service("Alarm1Service", function($q, $timeout) {
